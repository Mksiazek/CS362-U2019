...
int main() {
...
#if (NOISY_TEST == 1)
	printf("Test ambassador %d with increase supply count for choosen card by amount being discarded\n", p);
#endif
	...
	int result = playAmbassador(state, choice1, choice2, handCount);
